...
public class ExternalSharingBoundary {
    ...
    public void inviaRichiestaAccesso(HttpExchange exchange){
            ...
            if (token == null || token.trim().isEmpty()) {
             ...
             control.verificaEsistenzaCondivisione(token);
    ...
    public void MandaErrore(Object exchangeOb){
    ...
    public void Reindirizza(Object exchangeOb,String url){
        if(exchangeOb instanceof HttpExchange){
